...
export default function Navbar() {
    ...
    function toggle() {
        ...
        document.getElementById("root").style.backgroundColor = darkMode ? '#000000' : '#ffffff';
        document.getElementById("root").style.color = darkMode ? '#ffffff' : '#000000';
    }
        ...
        >
            <div className="navbar">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-xl">Shah BookStore</a>
                </div>
                <div className="navbar-end">
                    ...
                    <div className="px-4 hidden md:block">
                        <label className="input border py-2 px-2 flex items-center gap-2 ">
